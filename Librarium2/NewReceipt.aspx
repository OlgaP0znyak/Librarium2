<%@ Page Title="Поступление" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewReceipt.aspx.cs" Inherits="Librarium2.NewReceipt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="height: 20px">
                <asp:TextBox ID="tbReceiptDate" runat="server" Width="280px" TextMode="Date" ReadOnly="True"></asp:TextBox>                
            </td>
        </tr>
        <tr>
            <td style="height: 20px; width: 155px">&nbsp;</td>
