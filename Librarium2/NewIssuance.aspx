<%@ Page Title="Выдача" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewIssuance.aspx.cs" Inherits="Librarium2.NewIssuance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="tbBook" runat="server" AutoPostBack="True" OnTextChanged="tbBook_TextChanged" Width="680px"></asp:TextBox>
            ...
            <td style="width: 87px">
                <asp:TextBox ID="tbCount" runat="server" AutoPostBack="True" TextMode="Number" Width="77px"></asp:TextBox>
            </td>
            <td>
